...
class ContactControllerTest {
    ...
    @Test
    void getContactFailNotFound() throws Exception {
        mockMvc.perform(
    ...
    void updateContactSuccess() throws Exception {
        ...
        request.setPhoneNumber("23123123");
        ...
        mockMvc.perform(
            ...
            assertEquals(request.getPhoneNumber(), response.getData().getPhone());
    ...
    @Test
    void deleteContactFailNotFound() throws Exception {
        mockMvc.perform(
